...
int main(){
    ...
    printf("Projeção de Gastos com Abono\n============================\n");

    while (1){
        
        printf("Salario %d: ", count + 1);
        scanf("%f", &salarios[count]);
        ...
        abono[count] = salarios[count] * 0.20; 
    ...
    printf("\nForam processados %d colaboradores", count);
    printf("\nTotal gasto com abonos: R$ %.2f", total_abono);
    printf("\nValor mínimo pago a %d colaboradores", a);
    printf("\nMaior valor de abono pago: R$ %.2f", maior_abono);
